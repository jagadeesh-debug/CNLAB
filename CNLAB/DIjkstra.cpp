...
void dijkstra(int n, vector<vector<int>>& graph, int s) {
    vector<int> smallestdistance(n, INT_MAX);//initially assign all values as infinity
    vector<bool> visited(n, false);//initially assign all values as not visited

    smallestdistance[s] = 0;//asssume graph starts from 0
